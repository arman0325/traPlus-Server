            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
                    ...
                    <div class="mx-auto y-4 mt-5">
                        <form class="form-horizontal" role="form" action="#" method="POST" onSubmit="return confirm('Do you confirm to submit new terminology?') ">
                            ...
                            <div class="form-group mt-2">
                                <label for="zh" class="col-sm control-label">Terminology</label>
                                <div class="col-sm-10">
